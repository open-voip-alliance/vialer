...
TestUser? _tester1;
TestUser? _tester2;
TestUser? _testUserNoAppAccount;
...
TestUser get testUserNoAppAccount =>
    _testUserNoAppAccount ??
        (_testUserNoAppAccount = TestUser(
          dotenv.env['TEST_USER_NO_APP_ACCOUNT_EMAIL']!,
          dotenv.env['TEST_USER_NO_APP_ACCOUNT_PASSWORD']!,
        ));
