...
class SettingTile extends StatelessWidget {
  ...
  static Widget availability(User user) {
    ...
    final destinations = user.settings.getOrNull(key);
        ...
        return Padding(
          ...
          child: AvailabilityTile(
            ...
            child: _MultipleChoiceSettingValue<Destination?>(
              value: destinations.activeDestination,
              items: [
                ...destinations.availableDestinations.map(
              ...
              onChanged: (destination) => destination != null
                  ? defaultOnChanged(
                      context,
                      key,
                      destinations.copyWith(activeDestination: destination),
                    )
                  : () {},
              isExpanded: true,
            ),
