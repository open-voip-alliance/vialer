...
class MainMessages_nl extends MainMessages {
  ...
  CallThroughMainMessages_nl get callThrough =>
      CallThroughMainMessages_nl(this);
...
class CallThroughMainMessages_nl extends CallThroughMainMessages {
  ...
  ErrorCallThroughMainMessages_nl get error =>
      ErrorCallThroughMainMessages_nl(this);
}
...
class DialerMainMessages_nl extends DialerMainMessages {
  ...
  String get permissionDenied =>
      """Er is geen permissie om te bellen, wat nodig is om via de app te bellen.""";
  MenuDialerMainMessages_nl get menu => MenuDialerMainMessages_nl(this);
  ConfirmDialerMainMessages_nl get confirm =>
      ConfirmDialerMainMessages_nl(this);
  NoPermissionDialerMainMessages_nl get noPermission =>
      NoPermissionDialerMainMessages_nl(this);
}
...
class ConfirmDialerMainMessages_nl extends ConfirmDialerMainMessages {
  ...
  DescriptionConfirmDialerMainMessages_nl get description =>
      DescriptionConfirmDialerMainMessages_nl(this);
  ButtonConfirmDialerMainMessages_nl get button =>
      ButtonConfirmDialerMainMessages_nl(this);
}

class DescriptionConfirmDialerMainMessages_nl
    extends DescriptionConfirmDialerMainMessages {
  ...
  String main(String appName) =>
      """$appName verbindt je gesprek door,\nwaardoor je persoonlijke nummer privé blijft""";
  String get action =>
      """Klik op de “Bel” knop om het volgende nummer te bellen:""";
  String get showPopUpSetting => """Toon dit niet meer""";
}

class ButtonConfirmDialerMainMessages_nl
    extends ButtonConfirmDialerMainMessages {
  final ConfirmDialerMainMessages_nl _parent;
...
class NoPermissionDialerMainMessages_nl extends NoPermissionDialerMainMessages {
  ...
  String description(String appName) =>
      """Om via $appName te kunnen bellen is jouw toestemming nodig. Druk op Toestaan zodra daarom gevraagd wordt, zodat je met $appName oproepen kunt ontvangen en naar behoren kan laten werken.""";
  String permanentDescription(String appName) =>
      """Om via $appName te kunnen bellen is jouw toestemming nodig. Je hebt deze toestemming niet gegeven. Om deze toestemming alsnog te geven zodat de app naar behoren kan werken, ga je naar de privacyinstellingen op jouw telefoon en geef je daar toestemming om $appName toegang te verlenen tot de telefoonfuncties.""";
...
class RecentMainMessages_nl extends RecentMainMessages {
  ...
  SnackBarRecentMainMessages_nl get snackBar =>
      SnackBarRecentMainMessages_nl(this);
...
class ListRecentMainMessages_nl extends ListRecentMainMessages {
  ...
  PopupMenuListRecentMainMessages_nl get popupMenu =>
      PopupMenuListRecentMainMessages_nl(this);
  EmptyListRecentMainMessages_nl get empty =>
      EmptyListRecentMainMessages_nl(this);
}

class PopupMenuListRecentMainMessages_nl
    extends PopupMenuListRecentMainMessages {
...
class EmptyListRecentMainMessages_nl extends EmptyListRecentMainMessages {
  ...
  String get description =>
      """Er is geen recente gespreks activiteit om te tonen. Zodra je iemand belt of zelf gebeld wordt, zal het hier verschijnen.""";
}
...
class ListContactsMainMessages_nl extends ListContactsMainMessages {
  ...
  EmptyListContactsMainMessages_nl get empty =>
      EmptyListContactsMainMessages_nl(this);
  NoPermissionListContactsMainMessages_nl get noPermission =>
      NoPermissionListContactsMainMessages_nl(this);
  ItemListContactsMainMessages_nl get item =>
      ItemListContactsMainMessages_nl(this);
}
...
class ItemListContactsMainMessages_nl extends ItemListContactsMainMessages {
  ...
  String numbers(int count) =>
      """$count ${_plural(count, one: 'nummer', many: 'nummers')}""";
  String emails(int count) =>
      """$count ${_plural(count, one: 'email', many: 'emails')}""";
}
...
class SettingsMainMessages_nl extends SettingsMainMessages {
  ...
  ButtonsSettingsMainMessages_nl get buttons =>
      ButtonsSettingsMainMessages_nl(this);
  FeedbackSettingsMainMessages_nl get feedback =>
      FeedbackSettingsMainMessages_nl(this);
}
...
class ListSettingsMainMessages_nl extends ListSettingsMainMessages {
  ...
  DebugListSettingsMainMessages_nl get debug =>
      DebugListSettingsMainMessages_nl(this);
...
class DebugListSettingsMainMessages_nl extends DebugListSettingsMainMessages {
  ...
  RemoteLoggingDebugListSettingsMainMessages_nl get remoteLogging =>
      RemoteLoggingDebugListSettingsMainMessages_nl(this);
}

class RemoteLoggingDebugListSettingsMainMessages_nl
    extends RemoteLoggingDebugListSettingsMainMessages {
  final DebugListSettingsMainMessages_nl _parent;
  const RemoteLoggingDebugListSettingsMainMessages_nl(this._parent)
      : super(_parent);
  String get title => """Remote logging""";
  String get description =>
      """Deel automatisch je handelingen in de app met onze ontwikkelaars om problemen en fouten op te sporen.""";
}
...
class FeedbackSettingsMainMessages_nl extends FeedbackSettingsMainMessages {
  ...
  PlaceholdersFeedbackSettingsMainMessages_nl get placeholders =>
      PlaceholdersFeedbackSettingsMainMessages_nl(this);
  String get snackBar => """Feedback verstuurd""";
  ButtonsFeedbackSettingsMainMessages_nl get buttons =>
      ButtonsFeedbackSettingsMainMessages_nl(this);
}

class PlaceholdersFeedbackSettingsMainMessages_nl
    extends PlaceholdersFeedbackSettingsMainMessages {
  final FeedbackSettingsMainMessages_nl _parent;
  const PlaceholdersFeedbackSettingsMainMessages_nl(this._parent)
      : super(_parent);
  String get title => """Titel""";
  String get text => """Vul hier je feedback in""";
}

class ButtonsFeedbackSettingsMainMessages_nl
    extends ButtonsFeedbackSettingsMainMessages {
  final FeedbackSettingsMainMessages_nl _parent;
...
class OnboardingMessages_nl extends OnboardingMessages {
  ...
  InitialOnboardingMessages_nl get initial =>
      InitialOnboardingMessages_nl(this);
  LoginOnboardingMessages_nl get login => LoginOnboardingMessages_nl(this);
  PasswordOnboardingMessages_nl get password =>
      PasswordOnboardingMessages_nl(this);
  PermissionOnboardingMessages_nl get permission =>
      PermissionOnboardingMessages_nl(this);
  VoicemailOnboardingMessages_nl get voicemail =>
      VoicemailOnboardingMessages_nl(this);
  WelcomeOnboardingMessages_nl get welcome =>
      WelcomeOnboardingMessages_nl(this);
}
...
class LoginOnboardingMessages_nl extends LoginOnboardingMessages {
  ...
  PlaceholderLoginOnboardingMessages_nl get placeholder =>
      PlaceholderLoginOnboardingMessages_nl(this);
  ButtonLoginOnboardingMessages_nl get button =>
      ButtonLoginOnboardingMessages_nl(this);
  ErrorLoginOnboardingMessages_nl get error =>
      ErrorLoginOnboardingMessages_nl(this);
}

class PlaceholderLoginOnboardingMessages_nl
    extends PlaceholderLoginOnboardingMessages {
...
class ErrorLoginOnboardingMessages_nl extends ErrorLoginOnboardingMessages {
  ...
  String get wrongCombination =>
      """Onjuiste gebruikersnaam & wachtwoord combinatie. Check je login gegevens en probeer het opnieuw.""";
}
...
class PasswordOnboardingMessages_nl extends PasswordOnboardingMessages {
  ...
  String get error =>
      """Je wachtwoord voldoet niet aan de hieronder gestelde eisen.""";
  String get requirements =>
      """Je wachtwoord moet bestaan uit minimaal 6 tekens, waarvan 1 niet-alfabetisch.""";
}
...
class PermissionOnboardingMessages_nl extends PermissionOnboardingMessages {
  ...
  ButtonPermissionOnboardingMessages_nl get button =>
      ButtonPermissionOnboardingMessages_nl(this);
  CallPermissionOnboardingMessages_nl get call =>
      CallPermissionOnboardingMessages_nl(this);
  ContactsPermissionOnboardingMessages_nl get contacts =>
      ContactsPermissionOnboardingMessages_nl(this);
}

class ButtonPermissionOnboardingMessages_nl
    extends ButtonPermissionOnboardingMessages {
...
class CallPermissionOnboardingMessages_nl
    extends CallPermissionOnboardingMessages {
  final PermissionOnboardingMessages_nl _parent;
  const CallPermissionOnboardingMessages_nl(this._parent) : super(_parent);
  String get title => """Bel permissie""";
  String get description =>
      """Deze permissie is nodig om te bellen met de standaard telefoon app.""";
}

class ContactsPermissionOnboardingMessages_nl
    extends ContactsPermissionOnboardingMessages {
  final PermissionOnboardingMessages_nl _parent;
  const ContactsPermissionOnboardingMessages_nl(this._parent) : super(_parent);
  String get title => """Toestemming contactenlijst""";
  String description(String appName) =>
      """Deze toestemming zorgt ervoor dat $appName informatie zoals de contactenlijst en gespreksactiviteit inzichtelijk maakt.
...
class VoicemailOnboardingMessages_nl extends VoicemailOnboardingMessages {
  ...
  String get description =>
      """Let op: als je jouw voicemail niet instelt, kan het voorkomen dat jouw privénummer wordt vermeld in de standaard voicemailmelding.
