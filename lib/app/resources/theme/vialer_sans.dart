...
import 'raw_logo.dart';

abstract class VialerSans {
  static const _family = 'VialerSans';

  static const brandVialer = IconData(RawLogos.vialer, fontFamily: _family);
  static const brandVoys = IconData(RawLogos.voys, fontFamily: _family);
  static const brandVerbonden = IconData(
    RawLogos.verbonden,
    fontFamily: _family,
  );
  static const brandAnnabel = IconData(RawLogos.annabel, fontFamily: _family);
