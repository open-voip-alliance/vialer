...
class DialerMainMessages {
  ...
  String get permissionDenied =>
      """The call permission is denied, which is required to make direct calls.""";
  ...
  NoPermissionDialerMainMessages get noPermission =>
      NoPermissionDialerMainMessages(this);
}
...
class ConfirmDialerMainMessages {
  ...
  DescriptionConfirmDialerMainMessages get description =>
      DescriptionConfirmDialerMainMessages(this);
  ButtonConfirmDialerMainMessages get button =>
      ButtonConfirmDialerMainMessages(this);
}
...
class NoPermissionDialerMainMessages {
  ...
  String description(String appName) =>
      """In order to call by using $appName, you need to allow the app to do so. Please press Allow when asked if you want to allow it to make and manage phone calls, so that the app can work properly.""";
  String permanentDescription(String appName) =>
      """In order to call by using $appName, you need to allow the app to do so. You have denied to give this permission. To change this so the app can work properly, please go to your phone privacy settings and allow $appName to access your phone abilities.""";
...
class ListRecentMainMessages {
  ...
  PopupMenuListRecentMainMessages get popupMenu =>
      PopupMenuListRecentMainMessages(this);
...
class EmptyListRecentMainMessages {
  ...
  String get description =>
      """There is no recent call activity to show. Once you make or receive a call, it will appear here.""";
}
...
class ListContactsMainMessages {
  ...
  EmptyListContactsMainMessages get empty =>
      EmptyListContactsMainMessages(this);
  NoPermissionListContactsMainMessages get noPermission =>
      NoPermissionListContactsMainMessages(this);
...
class EmptyListContactsMainMessages {
  ...
  String description(String appName) =>
      """$appName was unable to find any contacts in your phone. If you create contacts they will be shown in $appName.""";
}
...
class NoPermissionListContactsMainMessages {
  ...
  String description(String appName) =>
      """$appName needs permission to retrieve your contacts and display them.""";
  String permanentDescription(String appName) =>
      """In order to retrieve your contacts and display them, you need to allow the app to do so. You have denied to give this permission. To change this so the app can work properly, please go to your phone privacy settings and allow $appName to access your contacts.""";
  String get button => """Give permission""";
}
...
class ItemListContactsMainMessages {
  ...
  String numbers(int count) =>
      """$count ${_plural(count, one: 'number', many: 'numbers')}""";
...
class SettingsMainMessages {
  ...
  FeedbackSettingsMainMessages get feedback =>
      FeedbackSettingsMainMessages(this);
}
...
class ListSettingsMainMessages {
  ...
  DebugListSettingsMainMessages get debug =>
      DebugListSettingsMainMessages(this);
...
class DebugListSettingsMainMessages {
  ...
  RemoteLoggingDebugListSettingsMainMessages get remoteLogging =>
      RemoteLoggingDebugListSettingsMainMessages(this);
}
...
class FeedbackSettingsMainMessages {
  ...
  PlaceholdersFeedbackSettingsMainMessages get placeholders =>
      PlaceholdersFeedbackSettingsMainMessages(this);
  String get snackBar => """Feedback sent""";
  ButtonsFeedbackSettingsMainMessages get buttons =>
      ButtonsFeedbackSettingsMainMessages(this);
}
...
class OnboardingMessages {
  ...
  PasswordOnboardingMessages get password => PasswordOnboardingMessages(this);
  PermissionOnboardingMessages get permission =>
      PermissionOnboardingMessages(this);
  VoicemailOnboardingMessages get voicemail =>
      VoicemailOnboardingMessages(this);
...
class LoginOnboardingMessages {
  ...
  PlaceholderLoginOnboardingMessages get placeholder =>
      PlaceholderLoginOnboardingMessages(this);
  ButtonLoginOnboardingMessages get button =>
      ButtonLoginOnboardingMessages(this);
...
class PasswordOnboardingMessages {
  final OnboardingMessages _parent;
  const PasswordOnboardingMessages(this._parent);
  String get title => """Change password""";
  String get button => """Save password""";
  String get error =>
      """Your password does not comply with the requirements mentioned below.""";
  String get requirements =>
      """Your password must be at least 6 characters long and include 1 non-alphabetical character.""";
}

class PermissionOnboardingMessages {
  final OnboardingMessages _parent;
  const PermissionOnboardingMessages(this._parent);
  ButtonPermissionOnboardingMessages get button =>
      ButtonPermissionOnboardingMessages(this);
  CallPermissionOnboardingMessages get call =>
      CallPermissionOnboardingMessages(this);
  ContactsPermissionOnboardingMessages get contacts =>
      ContactsPermissionOnboardingMessages(this);
}
...
class CallPermissionOnboardingMessages {
  ...
  String get description =>
      """This permission is required to make calls directly from the app using the default call app.""";
}
...
class ContactsPermissionOnboardingMessages {
  ...
  String description(String appName) =>
      """This permission allows $appName to display information (contact book & call activity) and to search through your contacts.
...
class VoicemailOnboardingMessages {
  ...
  String get description =>
      """Please be aware that if you haven't set up your voicemail, the automated message may contain your private number.
